...
class Payment{ 
    public:
        virtual double calculateCost(int minutes) = 0;
}; 

class CarPayment : public Payment{
    public:
        double calculateCost(int minutes){
            return minutes*3; //3 rupees per minute
        }
};
...
class BikePayment : public Payment{
    public:
        double calculateCost(int minutes){
            return minutes*2; //2 rupees per minute
        }
};
...
class HandicappedPayment : public Payment{
    public:
        double calculateCost(int minutes){
            return minutes*1; //1 rupees per minute
        }
};
...
class Vehicle{
    ...
    public:
        ...
        virtual double calculateCost(int minutes){
            return payment->calculateCost(minutes);
        } 
